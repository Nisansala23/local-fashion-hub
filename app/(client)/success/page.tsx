...
// 🌟 Sub-Component to handle the client-side dynamic search parameters safely
...
// 4. Main Export wrapped in an isolated React Suspense Boundary
        ...
        <div className="w-full bg-[#f8fafc] py-16 px-4 flex items-center justify-center min-h-[85vh]">
            <Suspense fallback={
                <div className="text-center py-10">
                    ...
                    <p className="text-xs text-gray-400 font-medium animate-pulse">Loading your transaction invoice details...</p>
                </div>
            }>
                <SuccessPageContent />
            </Suspense>
